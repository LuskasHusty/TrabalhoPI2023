//Image Parser Versão 2.1
/*
    Versão em que o algoritmo de Bresenham é implementado
    de forma em que suas pré condições são validadas.
    Incorreto pois o eixo X e Y do array está invertido
    em relação a imagem
*/
